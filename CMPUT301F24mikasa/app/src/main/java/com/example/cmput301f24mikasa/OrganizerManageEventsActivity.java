...
public class OrganizerManageEventsActivity extends AppCompatActivity implements EventArrayAdapter.OnEventClickListener {
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document != null && document.exists()) {
                        ...
                        if (eventTitle != null) {
                            ...
                            Intent intent = new Intent(OrganizerManageEventsActivity.this, WaitingListActivity.class);
    ...
    public void onDeleteButtonClick(Event event) {
        ...
        db.collection("event").document(event.getEventID()) // Ensure `Event` has an `id` field set with Firestore document ID
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    adapter.notifyDataSetChanged();
                    Toast.makeText(OrganizerManageEventsActivity.this, "Event deleted successfully!", Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> {
                    Log.e("OrganizerManageEvents", "Error deleting event", e);
                    Toast.makeText(OrganizerManageEventsActivity.this, "Failed to delete event.", Toast.LENGTH_SHORT).show();
                });
        Toast.makeText(OrganizerManageEventsActivity.this, "Event deleted successfully!", Toast.LENGTH_SHORT).show();
    }
    @Override

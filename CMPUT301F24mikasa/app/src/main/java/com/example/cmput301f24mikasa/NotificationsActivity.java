...
public class NotificationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setAdapter(adapter); // Set adapter to display notifications

    }

    /**
     * Method to load notifications for a specific user from Firestore.
     *
     * @param userID The unique identifier for the user whose notifications are to be loaded.
     */
